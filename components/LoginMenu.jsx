        ...
        return (
            ...
            <div className="h-screen w-auto">
                <div className="flex justify-start items-start">
                    <div className=" h-screen w-auto  bg-transparent custom-shadow_2 rounded-r-2xl pl-5 xs:pl-2 md:pr-3">
                        <div>
                            <div className="flex flex-col text-center items-center gap-7 md:grid grid-rows-5 md:text-xltext-[#000000]">
                                ...
                                <Link href={'/'}>
                                    <div className="px-4 row-start-1 md:flex items-center">
                                        ...
                                        <div className="sm:block md:hidden font-bold">
                                            Account
                                        </div>
                                    </div>
                                </Link>
